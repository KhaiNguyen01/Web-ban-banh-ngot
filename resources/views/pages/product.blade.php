                ...
                <div class="col-sm-4">
                  <div class="single-item">
                    ...
                    <div class="single-item-header">
                      <a href="product/{{$relatedproduct->id}}"><img src="source/image/product/{{$relatedproduct->image}}" alt="" height="250px"></a>
                    </div>
                    <div class="single-item-body">
                      <p class="single-item-title">{{$relatedproduct->name}}</p>
                      <p class="single-item-price">
                        @if($relatedproduct->promotion_price==0)
                          <span class="flash-sale">{{number_format($relatedproduct->unit_price)}} đ</span>
                          @else
                    ...
                    <div class="single-item-caption">
                      ...
                      <a class="beta-btn primary" href="product/{{$relatedproduct->id}}">Details <i class="fa fa-chevron-right"></i></a>
                      <div class="clearfix"></div>
                      <br>
                    </div>
                  </div>
