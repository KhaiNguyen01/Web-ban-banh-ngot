...
@section('content')
		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb">
					<a href="index">Home</a> / <span>Đặt hàng</span>
				</div>
			</div>
	...
	<div class="container">
		<div id="content">
			...
			<form name="order_form" action="check_out" method="post" class="beta-form-checkout">
						...
						<div class="your-order">
			              ...
			              @endif
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{number_format($totalPrice)}} đ</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
								...
								<ul class="payment_methods methods">
									...
									<li class="payment_method_cheque">
										...
										<div class="payment_box payment_method_cheque" style="display: none;">
											...
											<br>- Chủ TK: Nguyễn A
											<br>- Ngân hàng ACB, Chi nhánh XYZ
										</div>
									</li>
